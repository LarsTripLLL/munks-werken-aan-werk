...
export class SupabaseDashboardRepository implements DashboardRepository {
  ...
  async addParticipant(trajectoryCode: string, input: Pick<DashboardParticipant, 'name' | 'email' | 'phone' | 'coachId'>): Promise<{ activationCode: string }> { return this.saveParticipant('create_participant', trajectoryCode, undefined, input) as Promise<{ activationCode: string }>; }
  async updateParticipant(trajectoryCode: string, participantId: string, input: Pick<DashboardParticipant, 'name' | 'email' | 'phone' | 'coachId' | 'active'>): Promise<void> { await this.saveParticipant('update_participant', trajectoryCode, participantId, input); }
  ...
  private async saveParticipant(action: 'create_participant' | 'update_participant' | 'renew_participant_activation', trajectoryCode: string, enrollmentId: string | undefined, input: Pick<DashboardParticipant, 'name' | 'email' | 'phone' | 'coachId'> & { active?: boolean }): Promise<void | { activationCode: string }> {
