...
export class ApiDashboardRepository implements DashboardRepository {
  ...
  addParticipant(trajectoryCode: string, input: Pick<DashboardParticipant, 'name' | 'email' | 'phone' | 'city' | 'birthDate' | 'coachId'>) {
  ...
  updateParticipant(trajectoryCode: string, participantId: string, input: Pick<DashboardParticipant, 'name' | 'email' | 'phone' | 'city' | 'birthDate' | 'coachId'>) {
