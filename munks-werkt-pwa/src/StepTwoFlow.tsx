...
export function StepTwoFlow({ repository, participantId, trajectoryCode, onClose }: { repository: TalentTestRepository; participantId: string; trajectoryCode: string; onClose: () => void; onComplete: () => Promise<void> }) {
