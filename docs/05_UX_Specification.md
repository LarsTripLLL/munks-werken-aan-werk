...
7. AI-assistent;
8. Werk zoeken en reageren;
9. globale navigatie;
10. algemene interactie- en contentregels;
11. fout-, laad- en lege toestanden;
12. toegankelijkheid en responsief gedrag.
...
# 21. UX008 – Werk zoeken en reageren

## 21.1 Doel

De jongere leren hoe passend werk kan worden gevonden, hoe een vacature kan worden begrepen en beoordeeld en hoe een passende reactie kan worden opgesteld.

Het leerproces staat centraal. Daadwerkelijk reageren is mogelijk, maar niet verplicht.

## 21.2 Doelgroep

Jongere.

## 21.3 Gerelateerd aan

- D003 De route is gezamenlijk, de ontwikkeling is persoonlijk;
- D017 Werk zoeken en reageren als vijfde trajectstap;
- PB013 Werk zoeken en reageren;
- UF007 Werk zoeken en reageren;
- UX007 AI-assistent.

## 21.4 Gewenste beleving

> Ik begrijp hoe ik werk kan zoeken en hoe ik kan reageren. Ik kan hiermee oefenen en bepaal zelf of ik mijn reactie echt verstuur.

## 21.5 Introductiescherm

Het introductiescherm bevat:

- stapnummer **5**;
- titel **Werk zoeken en reageren**;
- hoofdtekst: **Ontdek hoe je werk vindt dat bij je past**;
- korte uitleg: *Je leert waar je kunt zoeken, hoe je een vacature bekijkt en hoe je kunt reageren. Wil je daarna echt reageren? Dan bepaal je dat zelf.*;
- geschatte tijd per activiteit, wanneer betrouwbaar;
- primaire actie **Begin met zoeken**.

## 21.6 Opbouw van de stap

De stap bestaat uit zes onderdelen:

1. **Waar kun je werk vinden?**  
   Kennismaken met vacaturesites, websites van werkgevers, sociale media, uitzendbureaus en het eigen netwerk.
2. **Wat past bij jou?**  
   Nadenken over soort werk, werkzaamheden, uren, locatie en werkomgeving.
3. **Een vacature bekijken**  
   Leren waar belangrijke informatie staat en wat het verschil is tussen harde eisen en wensen.
4. **Past dit werk bij jou?**  
   Benoemen wat aanspreekt, wat vragen oproept en welke punten mogelijk niet passen.
5. **Hoe kun je reageren?**  
   Verschillende manieren bekijken om belangstelling te tonen, met een natuurlijk geformuleerd voorbeeld.
6. **Jouw reactie voorbereiden**  
   Een korte reactie in eigen woorden voorbereiden en bewaren als oefening. De reactie wordt niet automatisch verstuurd.

## 21.7 Uitleg van het woord vacature

Wanneer het woord **vacature** voor het eerst wordt gebruikt, geeft de app een korte uitleg:

> Een vacature is een bericht waarin een werkgever vertelt welk werk er beschikbaar is en wie daarvoor wordt gezocht.

De titel van de trajectstap blijft **Werk zoeken en reageren**, omdat dit begrijpelijker en minder formeel klinkt.

## 21.8 Vacature bekijken

De app helpt minimaal de volgende informatie herkennen:

- welk werk wordt aangeboden;
- welke werkzaamheden erbij horen;
- waar en wanneer het werk plaatsvindt;
- hoeveel uren het betreft;
- wat een werkgever vraagt;
- hoe iemand kan reageren;
- tot wanneer reageren mogelijk is, indien vermeld.

De app maakt duidelijk dat niet iedere genoemde wens automatisch een harde voorwaarde is.

## 21.9 Reactie oefenen

De jongere kan een conceptreactie maken voor bijvoorbeeld:
...
De reactie kan worden opgebouwd uit kleine vragen, zoals:

- Op welk werk reageer je?
- Waarom spreekt dit werk je aan?
- Welke ervaring of kwaliteit wil je noemen?
- Hoe kan de werkgever contact met je opnemen?

De AI-assistent mag tekstvoorstellen doen, maar presenteert deze altijd als aanpasbaar voorstel. De reactie moet herkenbaar blijven als de eigen boodschap van de jongere.

## 21.10 Eigen regie en verzending

- oefenen is voldoende om de stap af te ronden;
- een concept wordt automatisch of expliciet opgeslagen;
- niets wordt automatisch naar een werkgever gestuurd;
- vóór verzending ziet de jongere de volledige reactie en ontvanger;
- verzending vereist een bewuste bevestiging;
- de jongere kan de begeleider vragen om mee te kijken;
- niet reageren wordt niet als mislukking weergegeven.

## 21.11 Lege en foutsituaties

**Nog geen voorbeeld gekozen**

> Kies een voorbeeld om samen te bekijken, of zoek eerst naar werk dat je aanspreekt.

**Zoeken tijdelijk niet beschikbaar**

> Er kunnen nu geen actuele resultaten worden opgehaald. Je kunt wel oefenen met een voorbeeld.

**Concept niet opgeslagen**

> Je reactie is nog niet opgeslagen. Probeer het opnieuw.

## 21.12 Succescriteria

De jongere kan zonder uitleg:

- minimaal twee manieren noemen om werk te zoeken;
- belangrijke informatie in een vacature vinden;
- aangeven waarom werk mogelijk wel of niet past;
- een korte conceptreactie opstellen;
- hulp van de AI-assistent of begeleider vinden;
- herkennen dat verzenden niet verplicht is;
- bewust kiezen tussen bewaren en daadwerkelijk reageren.

## 21.13 Ontwerpuitgangspunten

- leren en oefenen staan centraal;
- eenvoudige taal vóór vaktaal;
- kleine onderdelen en één hoofdactie per scherm;
- geen druk om daadwerkelijk te solliciteren;
- transparant onderscheid tussen een oefening en een echte verzending;
- eigen regie bij iedere externe actie.

## 21.14 Openstaande ontwerpvragen

- Werkt de pilot met vaste voorbeeldvacatures, actuele zoekresultaten of beide?
- Vanuit welke bronnen mogen actuele vacatures worden opgehaald?
- Kan daadwerkelijk verzenden vanuit de app, of alleen via de oorspronkelijke website of contactmethode?
- Welke conceptreacties worden bewaard en wie kan deze inzien?

---

# 22. Responsief gedrag

## 22.1 Jongerenomgeving
...
# 24. Notificaties en herinneringen
...
# 25. Analytics en gebruiksmeting
...
# 26. Acceptatiecriteria voor Design Ready
...
# 27. Openstaande besluiten vóór ontwikkeling
...
| O012 | Werk zoeken | Bronnen, voorbeeldvacatures, opslag van conceptreacties en eventuele verzendroute |
...
# 22. UX009 – Jouw volgende stap

## 22.1 Doel

De uitkomst van het eindgesprek overzichtelijk en persoonlijk tonen, zodat de jongere weet welke richting is gekozen en wat de eerstvolgende actie is.
...
Het scherm **Jouw volgende stap** toont:

- **Mijn richting** – het afgesproken doel of de gekozen richting;
- **Mijn eerste actie** – één concrete en haalbare vervolghandeling;
- **Wanneer?** – de afgesproken datum of periode;
- **Wie helpt mij?** – de begeleider en eventueel iemand uit het eigen netwerk.

Het scherm bevat daarnaast:

- primaire actie **Bekijk mijn hele plan**;
- toegang tot **Vraag hulp aan mijn begeleider**;
- de uitleg dat het plan in overleg mag veranderen.

## 22.4 Gewenste beleving

> Ik weet wat mijn volgende stap is, wanneer ik begin en wie mij helpt.

## 22.5 Grenzen

- geen herhaling van de verkenning uit stap 7;
- geen automatische verzending naar werkgevers, opleidingen of andere partijen;
- wijzigingen in de afspraken worden samen met de begeleider gemaakt;
- de formulering blijft persoonlijk, haalbaar en niet-oordelend.
